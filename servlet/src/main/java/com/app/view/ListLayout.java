...
public abstract class ListLayout<T> {

	protected String _htmlHeader = "<!doctype html>\n" + 
				"<html lang=\"en\">\n" + 
				" <head>\n" + 
	...
	protected String _htmlFooter = "      </table>\n" + 
				"     </div>\n" + 
				"    </div>\n" + 
				"   </div>\n" + 
				"   <footer>\n" + 
	...
	protected abstract String tableBody(List<T> items);
